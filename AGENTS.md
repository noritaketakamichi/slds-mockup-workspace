...
- テンプレート: `.Codex/templates/parts/global-nav.html`
...
- 右上: アクションボタン群
- テンプレート: `.Codex/templates/parts/highlights-panel.html`

### 4. Path コンポーネント (`slds-path`) ※ステータス遷移がある場合
- 横長のステップバー。完了=チェック付き、現在=青塗り、未到達=グレー
- テンプレート: `.Codex/templates/parts/path.html`
...
- テンプレート: `.Codex/templates/parts/record-body.html`

### 6. 関連リストの構造
- ヘッダー: 色付きアイコン + タイトル(件数) + ソート情報 + リフレッシュボタン
- テーブル: ソート可能なカラムヘッダー（ドロップダウン矢印付き）
- テンプレート: `.Codex/templates/parts/related-list.html`
...
- **レコード詳細画面**: `.Codex/templates/record-detail-page.html` をベースにすること（★推奨）
- パーツテンプレート: `.Codex/templates/parts/` 内の各パーツを参考にすること
- 一覧系: `.Codex/templates/list-page.html`
- モーダル: `.Codex/templates/modal-pattern.html`
- ベースHTML: `.Codex/templates/mockup-base.html`
- デザイントークン: `.Codex/templates/design-tokens.md`
