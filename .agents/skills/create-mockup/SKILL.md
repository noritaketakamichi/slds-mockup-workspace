...
すべてのテンプレートは本スキルの `templates/` ディレクトリに含まれている。

### ページテンプレート
| ファイル | 用途 |
|---------|------|
| `templates/record-detail-page.html` | レコード詳細画面（★推奨ベース） |
| `templates/list-view-page.html` | リストビュー画面 |
| `templates/detail-page.html` | シンプルな詳細ページ |
| `templates/list-page.html` | シンプルな一覧ページ |
| `templates/modal-pattern.html` | モーダルダイアログ |
| `templates/mockup-base.html` | 最小HTML骨格 |

### パーツテンプレート
| ファイル | 用途 |
|---------|------|
| `templates/parts/global-nav.html` | グローバルナビゲーション + タブバー |
| `templates/parts/highlights-panel.html` | Highlights Panel（レコードヘッダー） |
| `templates/parts/path.html` | Path コンポーネント（ステータス遷移） |
| `templates/parts/related-list.html` | 関連リスト |
| `templates/parts/record-body.html` | レコードページ本体（2カラム） |

### デザインリファレンス
| ファイル | 用途 |
|---------|------|
| `templates/design-tokens.md` | SLDSデザイントークン一覧 |
...
画面タイプに応じたテンプレートを **本スキルの `templates/` ディレクトリ** から読み込む。

- レコード詳細画面 → `templates/record-detail-page.html` + `templates/parts/` 配下
- リストビュー画面 → `templates/list-view-page.html`
- モーダル → `templates/modal-pattern.html`
- 既存モックアップの参照 → `mockups/` ディレクトリ
...
### テンプレート参照先
- `templates/record-detail-page.html`
- `templates/parts/highlights-panel.html`
- `templates/parts/path.html`
- `templates/parts/record-body.html`
- `templates/parts/related-list.html`
